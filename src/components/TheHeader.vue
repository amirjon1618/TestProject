        ...
        <div class="relative flex items-center justify-between h-16">
          ...
          >
            <div class="flex-shrink-0 flex items-center mr-10 items-center">
              <a href="#" class="text-[28px] text-[#171725] font-bold">GMPortal</a>
          </div>
            <div
            ...
            >
              <div class="flex w-full h-12 relative ">
                <input
                  ...
                  id=""
                  placeholder="Поиск..."
                  class="lg:block hidden border border-grey-300 w-full px-3 shadow-inner rounded-2xl focus:outline-none focus:border-blue-700 bg-gray-50"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="sm:block sm:ml-6 items-center">
              <div class="flex space-x-4">
                <a
                  href="#"
                  class="text-gray-500 hover:underline px-3 py-2 rounded-md text-sm font-medium"
                  aria-current="page"
                  >Главная</a
                >
          ...
          >
            <div class="ml-5 relative">
              <div>
                <button
                  type="button"
                  class=" flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-600 focus:ring-white bg-gray-300"
                  id="user-menu-button"
                  aria-expanded="false"
                  aria-haspopup="true"
                >
